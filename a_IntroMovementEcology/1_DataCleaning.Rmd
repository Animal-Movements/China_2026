...
# Create list
lf <- list.files(path="D:/GitHub/Courses/China_2025/1_IntroMovementEcology/Data/", pattern = '.csv', all.files=FALSE, full.names=TRUE)
lf

lf <- list.files(path="./a_IntroMovementEcology/Data/", pattern = '.csv', all.files=FALSE, full.names=TRUE)
lf
