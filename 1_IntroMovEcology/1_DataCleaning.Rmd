...
Data in this example were collected in Kenya.  We will create and object for UTC (Coordinated Universal Time) time, but import all data as East Africa Time (EAT).  See the [wiki](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones) for your appropriate timezone identifier.
...
<center>
![[Source: ESRI](Figures/projections-esri-blog.png)]{width=75%}
</center>
<br>
...
I recommend importing your data with geographic (Lat/Long) coordinates, converting these values to your selected coordinate system.
...
`Tmap` also has a number of helpful vignettes to get products up and running.  The vignettes can be found [here]( https://cran.r-project.org/web/packages/tmap/vignettes/tmap-getstarted.html).
...
2. Check the coordinate reference system and re-projectm if necessary
