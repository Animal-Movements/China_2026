...
# Reference Dataset
WB.ref <- as.data.frame(movebank_download_deployment(study_id = "White-bearded wildebeest (Connochaetes taurinus) movements - Kenya"))
...
#WB <- as.data.frame(read_csv("Data/WB_FullDataset.csv"))
#WB.ref <- as.data.frame(read_csv("Data/WB_FullDataset_ref.csv"))
