...
# We can now see error in indiv turtle movement (most of the variation is explained by error)
plot(turtle[[1]])  # most of the variation is explained by error
