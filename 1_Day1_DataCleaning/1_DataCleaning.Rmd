...
# Exercise:
Now that you have uploaded and manipulated the wildebeest data in [R](https://cran.r-project.org/), please adapt the code with your own data.  Use [Movebank](https://www.movebank.org/) to download an available data or upload your data directly using read_csv (or other).  Please do the following:
