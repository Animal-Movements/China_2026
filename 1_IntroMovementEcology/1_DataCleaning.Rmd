...
#WB <- as.data.frame(read_csv("1_IntroMovementEcology/Data/White-bearded wildebeest (Connochaetes taurinus) movements - Kenya.csv"))

# Or list the files so we don't have to type so much
# Create list
lf <- list.files(path="D:/Jared/GitHub/2_Courses/China_2025/1_IntroMovementEcology/Data/", pattern = '.csv', all.files=FALSE, full.names=TRUE)
lf

lf <- list.files(path="./1_IntroMovementEcology/Data/", pattern = '.csv', all.files=FALSE, full.names=TRUE)
lf
