...
## # Description: A script which details basic commands on how to manipulate data
## # Author: <Your Name>
...
# You can create multiple columns at once.  Best to put each new column on a separate line.  This makes the code more readable.
...
## ----warning=T, message=T, eval=F, echo=F-----------------------------------------------------------------------
## # Read in the CSV
