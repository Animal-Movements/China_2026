...
In this module, we will walk through how to calculate and interpret a periodogram for movement data and the process of fitting and selecting a periodic movement model. We will revisit the topic of variograms for assessing autocorrelation (see the "Introduction to CTMM" module ["ctmm_intro.rmd"]), and how we can incorporate periodicity into our autocorrelation models.
